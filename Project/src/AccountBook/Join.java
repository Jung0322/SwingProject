...
//		panel.add(lblNewLabel);
		...
		lblNewLabel_1.setFont(new Font("IM혜민 Bold", Font.PLAIN, 12));
		...
		overlap.setFont(new Font("IM혜민 Bold", Font.PLAIN, 12));
		...
		Label.setFont(new Font("IM혜민 Bold", Font.PLAIN, 12));
		...
		lblNewLabel_4.setFont(new Font("IM혜민 Bold", Font.PLAIN, 12));
		...
		confirm.setFont(new Font("IM혜민 Bold", Font.PLAIN, 12));
...
//					frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		cancel.setFont(new Font("IM혜민 Bold", Font.PLAIN, 12));
